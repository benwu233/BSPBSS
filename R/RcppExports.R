...
GP_update_b_SGHMC <- function(b, X, A, S, sigma, lambda, tau, psi, epsilon, sumb, zeta, X_core, eta, sizep, sizen, m, itr, nu) {
    invisible(.Call('_BSPBSS_GP_update_b_SGHMC', PACKAGE = 'BSPBSS', b, X, A, S, sigma, lambda, tau, psi, epsilon, sumb, zeta, X_core, eta, sizep, sizen, m, itr, nu))
}
...
mcmc_bspbss_c <- function(X, A, b, tau, sigma, zeta, subsample_n, subsample_p, prior, psi, lambda, epsilon, lr, MClength, burn_in, thin, show_step) {
    .Call('_BSPBSS_mcmc_bspbss_c', PACKAGE = 'BSPBSS', X, A, b, tau, sigma, zeta, subsample_n, subsample_p, prior, psi, lambda, epsilon, lr, MClength, burn_in, thin, show_step)
}
